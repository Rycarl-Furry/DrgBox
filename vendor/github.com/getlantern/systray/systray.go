...
// SetOnClick installs a handler for a primary click on the Windows tray icon.
// A right click still opens the standard tray menu.
func SetOnClick(handler func()) { trayClick = handler }
